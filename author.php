            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li><a href="author.php?a_id=' . $auth_id . '&page=' . ($page - 1) . '">Prev</a></li>';
                        }
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            echo '<li class="' . $active . '"><a href="author.php?a_id=' . $auth_id . '&page=' . $i . '">' . $i . '</a></li>';
                        }
                        if ($total_page > $page) {
                            echo '<li><a href="author.php?a_id=' . $auth_id . '&page=' . ($page + 1) . '">Next</a></li>';
                        }
                        echo '</ul>';
                    }
                    ?>
